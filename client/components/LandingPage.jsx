          ...
          <div className="row center-align">
            <div className="col s12 ">
              <h4 className="teal-text teal-darken-2">
                Build your personalize scrapbook and share it!
              </h4>
            </div>
          </div>
        </div>
            ...
            <div className="white col s12 m4">
              <div className="icon-block">
                ...
                <p className="light">
                  ...
                  continually stimulates, that overexcites. Not only because it
                  can always be added to, but because it is already too much.
                  The collector’s need is precisely for excess, for surfeit, for
                  profusion. It’s too much—and it’s just enough for me. … A
                  collection is always more than is necessary. ”
                </p>
